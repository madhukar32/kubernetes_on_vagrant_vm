...
###### Ubuntu Update Repos
deb http://01.archive.ubuntu.com/ubuntu/ xenial-security main restricted
universe multiverse
deb http://01.archive.ubuntu.com/ubuntu/ xenial-updates main restricted universe
multiverse
deb http://01.archive.ubuntu.com/ubuntu/ xenial-proposed main restricted
universe multiverse
deb http://01.archive.ubuntu.com/ubuntu/ xenial-backports main restricted
universe multiverse
deb-src http://01.archive.ubuntu.com/ubuntu/ xenial-security main restricted
universe multiverse
deb-src http://01.archive.ubuntu.com/ubuntu/ xenial-updates main restricted
universe multiverse
deb-src http://01.archive.ubuntu.com/ubuntu/ xenial-proposed main restricted
universe multiverse
deb-src http://01.archive.ubuntu.com/ubuntu/ xenial-backports main restricted
universe multiverse
EOF'
